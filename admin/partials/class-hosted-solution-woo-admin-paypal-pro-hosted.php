...
/**
 * @class       Hosted_Solution_Woo_Admin_WooCommerce_Pro_Hosted
 * @version	1.0.0
 * @package	all-in-one-paypal-for-woocommerce
 * @category	Class
 * @author      mbj-webdevelopment <mbjwebdevelopment@gmail.com>
 */
class Hosted_Solution_Woo_Admin_WooCommerce_Pro_Hosted extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        add_action('woocommerce_api_hosted_solution_woo_admin_woocommerce_pro_hosted', array($this, 'relay_response'));
    ...
    public function process_payment($order_id) {
        ...
        $params = array('business' => $this->email,
            ...
            'paymentaction' => 'sale',
            'return' => add_query_arg('wc-api', 'Hosted_Solution_Woo_Admin_WooCommerce_Pro_Hosted', home_url('/')),
            'notify_url' => '',
